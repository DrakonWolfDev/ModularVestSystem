class CfgPatches
{
	class ModularVestSystem
	{
		units[] =
		{
			...
			"MVS_WeaponBag_Green",
			"MVS_WeaponBag_Tan",
			"MVS_WeaponBag_D_Black",
			"MVS_WeaponBag_D_Green",
			"MVS_WeaponBag_D_Tan",
			"MVS_RifleBag_Black",
			"MVS_RifleBag_Green",
			"MVS_RifleBag_Tan",
			"MVS_RifleBag_Desert_Camo",
			"MVS_RifleBag_Winter",
			"MVS_RifleBag_Winter_Camo",
			"MVS_RifleBag_Diagonal_Black",
			"MVS_RifleBag_Diagonal_Green",
			"MVS_RifleBag_Diagonal_Tan",
			"MVS_RifleBag_Diagonal_Desert_Camo",
			"MVS_RifleBag_Diagonal_Winter",
			"MVS_RifleBag_Diagonal_Winter_Camo",
			"MVS_Rucksack_OD",
			"MVS_Rucksack_ERDL",
			"MVS_Rucksack_Tan",
			"MVS_Rucksack_Black",
...
class cfgVehicles
{
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[] =
					{
						{1, {"ModularVestSystem\data\canteen\canteen.rvmat"}},
						...
						{0, {"ModularVestSystem\data\canteen\canteen_destruct.rvmat"}}
					};
				};
			};
		};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\vestTextures\vest.rvmat"}},
						...
						{0, {"ModularVestSystem\data\vestTextures\vest_destruct.rvmat"}}
					};
				};
			};
			class GlobalArmor
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\vestTextures\MVSHeavy.rvmat"}},
						...
						{0, {"ModularVestSystem\data\vestTextures\MVSHeavy_destruct.rvmat"}}
					};
				};
			};
			class GlobalArmor
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\vestTextures\chestrig.rvmat"}},
						...
						{0, {"ModularVestSystem\data\vestTextures\chestrig_destruct.rvmat"}}
					};
				};
			};
		};
	...
	class MVS_Molle_Panel_Base: MVS_Pouch_Base
	{
		...
		descriptionShort="The MVS molle panel attaches to the MVS belt and can store up to four compatible grenade-slot items.";
	...
	class Modular_Pouch_Base_Taco: MVS_Pouch_Base
	{
		...
		descriptionShort="The MVS Raid Pouch can hold magazines, pliers, a screwdriver, and a lockpick.";
		model="\ModularVestSystem\data\modular_pouch_12.p3d";
		attachments[] = {"magazine", "magazine2", "Screwdriver1", "Pliers1", "MVS_Lockpick"};
		rotationFlags=0;
		itemSize[]={4,3};
		itemsCargoSize[]={6,4};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\vestTextures\taco.rvmat"}},
						...
						{0, {"ModularVestSystem\data\vestTextures\taco_destruct.rvmat"}}
					};
				};
			};
		};
	...
	{
		scope=0;
		displayName="MVS Admin Pouch";
		descriptionShort="The MVS Admin Pouch is useful for quick-access items such as NVGs and batteries.";
	...
	class Modular_Pouch_Base_Heavy: MVS_Pouch_Base
	{
		...
		descriptionShort="The MVS Heavy LMG Pouch is useful for belt-fed ammunition or drum magazines.";
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\vestTextures\vestheavy.rvmat"}},
						...
						{0, {"ModularVestSystem\data\vestTextures\vestheavy_destruct.rvmat"}}
					};
				};
			};
		};
	...
	{
		scope=0;
		displayName="MVS Utility Pouch";
		descriptionShort="The MVS Utility Pouch is useful for a knife or multitool.";
	...
	class Modular_Pouch_Base_Medical: MVS_Pouch_Base
	{
		...
		descriptionShort="The MVS Medical Pouch has external attachment points for morphine, epinephrine, and bandages.";
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Helmets\do_helmet.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Helmets\do_helmet_destruct.rvmat"}}
					};
				};
			};
		};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Helmets\MVS_Helmet_2.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Helmets\mvs_helmet_2_destruct.rvmat"}}
					};
				};
			};
		};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Helmets\MVS_6B47.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Helmets\MVS_6B47_destruct.rvmat"}}
					};
				};
			};
		};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Helmets\OpsCore.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Helmets\OpsCore_destruct.rvmat"}}
					};
				};
			};
		};
				...
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"ModularVestSystem\data\Helmets\OpsCore_damage.rvmat",
								"ModularVestSystem\data\Helmets\OpsCoreMandible_damage.rvmat"
							}
						},
						...
						
						{
							...
							{
								"ModularVestSystem\data\Helmets\OpsCore_destruct.rvmat",
								"ModularVestSystem\data\Helmets\OpsCoreMandible_destruct.rvmat"
							}
						}
					};
				};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Helmets\MVS_Altyn.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Helmets\MVS_Altyn_destruct.rvmat"}}
					};
				};
			};
			class GlobalArmor
	...
	class MVS_WarriorHelmet_Base: MVS_ArmoredHelmet_Base
	{
		...
		hiddenSelectionsMaterials[] = {"ModularVestSystem\data\Helmets\OpsCore.rvmat", "ModularVestSystem\data\Helmets\MandalorianHelmet.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"ModularVestSystem\data\Helmets\OpsCore_damage.rvmat",
								"ModularVestSystem\data\Helmets\MandalorianHelmet_damage.rvmat"
							}
						},
						...
						
						{
							...
							{
								"ModularVestSystem\data\Helmets\OpsCore_destruct.rvmat",
								"ModularVestSystem\data\Helmets\MandalorianHelmet_destruct.rvmat"
							}
						}
					};
				};
	...
	class MVS_Pakol_ColorBase: Clothing
	{
		displayName="Pakol";
		...
		hiddenSelections[] = {"camoGround", "camoMale", "camoFemale"};
		hiddenSelectionsMaterials[] = {"ModularVestSystem\data\Helmets\acr_equip2.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Helmets\acr_equip2.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Helmets\acr_equip2_destruct.rvmat"}}
					};
				};
			};
		};
	...
	class MVS_Pakol_brown: MVS_Pakol_ColorBase
	{
		scope=2;
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Pack\pack.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Pack\pack_destruct.rvmat"}}
					};
				};
			};
		};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Pack\RaidPack.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Pack\RaidPack_destruct.rvmat"}}
					};
				};
			};
		};
	...
	class MVS_Sling_Pack_Base: MVS_Pack_Base
	{
		...
		descriptionShort="The MVS Sling Pack is a medium-sized pack with attachable storage. It can attach MVS admin or medical pouches, a rifle, and an identifier patch.";
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Pack\SlingPack.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Pack\SlingPack_destruct.rvmat"}}
					};
				};
			};
		};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Pack\MVS_Compact_1.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Pack\MVS_Compact_1_destruct.rvmat"}}
					};
				};
			};
		};
	...
	class MVS_Compact_Base_2: MVS_Pack_Base
	{
		...
		hiddenSelectionsMaterials[] = {"ModularVestSystem\data\Pack\MVS_Compact_2.rvmat", "ModularVestSystem\data\Pack\MVS_Compact_2_Detail.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"ModularVestSystem\data\Pack\MVS_Compact_2_damage.rvmat",
								"ModularVestSystem\data\Pack\MVS_Compact_2_Detail_damage.rvmat"
							}
						},
						...
						
						{
							...
							{
								"ModularVestSystem\data\Pack\MVS_Compact_2_destruct.rvmat",
								"ModularVestSystem\data\Pack\MVS_Compact_2_Detail_destruct.rvmat"
							}
						}
					};
				};
	...
	{
		scope=2;
		displayName="MVS Radio Pack - Tan";
		descriptionShort="The MVS Radio Pack accepts an MVS admin or medical pouch, a rifle, an identifier patch, and the MVS radio.";
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Pack\RadioPack.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Pack\RadioPack_destruct.rvmat"}}
					};
				};
			};
		};
	...
	class MVS_Radio: BaseRadio
	{
		...
		descriptionShort="This radio attaches to the MVS Radio Pack for long-distance communication.";
		model="\ModularVestSystem\data\Pack\RottensRadio.p3d";
		weight=2000;
		inventorySlot[] = {"RottensRadio"};
		hiddenSelections[] = {"zbytek"};
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\Pack\Radio_co.paa"};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Pack\Radio.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Pack\radio_destruct.rvmat"}}
					};
				};
			};
		};
	};
	class MVS_WeaponBag_Base: Clothing_Base
	{
		scope=0;
		displayName="Weapon Bag";
		descriptionShort="A lightweight weapon bag with two rifle attachment points.";
		model="\ModularVestSystem\data\WeaponBag\Weaponbag_g.p3d";
		inventorySlot[] = {"Back"};
		attachments[] = {"MVS_Weapon1", "MVS_Weapon2"};
		...
		randomQuantity=4;
		hiddenSelections[] = {"camoGround", "camoMale", "camoFemale"};
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\WeaponBag\Weaponbag_Black_co.paa", "\ModularVestSystem\data\WeaponBag\Weaponbag_Black_co.paa", "\ModularVestSystem\data\WeaponBag\Weaponbag_Black_co.paa"};
		class ClothingTypes
		{
			male="\ModularVestSystem\data\WeaponBag\Weaponbag_m.p3d";
			female="\ModularVestSystem\data\WeaponBag\Weaponbag_f.p3d";
		};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\WeaponBag\WeaponBag.rvmat"}},
						{0.7, {"ModularVestSystem\data\WeaponBag\WeaponBag.rvmat"}},
						{0.5, {"ModularVestSystem\data\WeaponBag\WeaponBag_damage.rvmat"}},
						{0.3, {"ModularVestSystem\data\WeaponBag\WeaponBag_damage.rvmat"}},
						{0, {"ModularVestSystem\data\WeaponBag\WeaponBag_destruct.rvmat"}}
					};
				};
			};
		};
	...
	class MVS_WeaponBag_Black: MVS_WeaponBag_Base
	{
		scope=2;
		displayName="Weapon Bag - Black";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\WeaponBag\Weaponbag_Black_co.paa", "\ModularVestSystem\data\WeaponBag\Weaponbag_Black_co.paa", "\ModularVestSystem\data\WeaponBag\Weaponbag_Black_co.paa"};
	};
	class MVS_WeaponBag_Green: MVS_WeaponBag_Base
	{
		scope=2;
		displayName="Weapon Bag - Green";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\WeaponBag\WeaponBag_Green_co.paa", "\ModularVestSystem\data\WeaponBag\WeaponBag_Green_co.paa", "\ModularVestSystem\data\WeaponBag\WeaponBag_Green_co.paa"};
	};
	class MVS_WeaponBag_Tan: MVS_WeaponBag_Base
	{
		scope=2;
		displayName="Weapon Bag - Tan";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\WeaponBag\WeaponBag_Tan_co.paa", "\ModularVestSystem\data\WeaponBag\WeaponBag_Tan_co.paa", "\ModularVestSystem\data\WeaponBag\WeaponBag_Tan_co.paa"};
	};
	class MVS_WeaponBag_D_Base: MVS_WeaponBag_Base
	{
		scope=0;
		displayName="Weapon Bag - Diagonal";
		model="\ModularVestSystem\data\WeaponBag\Weaponbag_D_g.p3d";
		class ClothingTypes
		{
			male="\ModularVestSystem\data\WeaponBag\Weaponbag_D_m.p3d";
			female="\ModularVestSystem\data\WeaponBag\Weaponbag_D_f.p3d";
		};
	};
	class MVS_WeaponBag_D_Black: MVS_WeaponBag_D_Base
	{
		scope=2;
		displayName="Weapon Bag - Diagonal Black";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\WeaponBag\Weaponbag_Black_co.paa", "\ModularVestSystem\data\WeaponBag\Weaponbag_Black_co.paa", "\ModularVestSystem\data\WeaponBag\Weaponbag_Black_co.paa"};
	};
	class MVS_WeaponBag_D_Green: MVS_WeaponBag_D_Base
	{
		scope=2;
		displayName="Weapon Bag - Diagonal Green";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\WeaponBag\WeaponBag_Green_co.paa", "\ModularVestSystem\data\WeaponBag\WeaponBag_Green_co.paa", "\ModularVestSystem\data\WeaponBag\WeaponBag_Green_co.paa"};
	};
	class MVS_WeaponBag_D_Tan: MVS_WeaponBag_D_Base
	{
		scope=2;
		displayName="Weapon Bag - Diagonal Tan";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\WeaponBag\WeaponBag_Tan_co.paa", "\ModularVestSystem\data\WeaponBag\WeaponBag_Tan_co.paa", "\ModularVestSystem\data\WeaponBag\WeaponBag_Tan_co.paa"};
	};
	class MVS_RifleBag_Base: Clothing_Base
	{
		scope=0;
		displayName="Rifle Bag";
		descriptionShort="A rifle bag with one visible rifle attachment point, two extra weapon slots, and external equipment slots.";
		model="\ModularVestSystem\data\riflebags\mvs_riflebag_g.p3d";
		inventorySlot[] = {"Back", "MVS_pack"};
		attachments[] =
		{
			"MVS_Weapon1",
		...
		randomQuantity=4;
		hiddenSelections[] = {"camoGround", "camoMale", "camoFemale"};
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\riflebags\mvs_riflebag_black_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_black_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_black_co.paa"};
		class ClothingTypes
		{
			male="\ModularVestSystem\data\riflebags\mvs_riflebag_m.p3d";
			female="\ModularVestSystem\data\riflebags\mvs_riflebag_f.p3d";
		};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\riflebags\mvs_riflebag.rvmat"}},
						{0.7, {"ModularVestSystem\data\riflebags\mvs_riflebag.rvmat"}},
						{0.5, {"ModularVestSystem\data\riflebags\mvs_riflebag_damage.rvmat"}},
						{0.3, {"ModularVestSystem\data\riflebags\mvs_riflebag_damage.rvmat"}},
						{0, {"ModularVestSystem\data\riflebags\mvs_riflebag_destruct.rvmat"}}
					};
				};
			};
		};
		...
		class GUIInventoryAttachmentsProps
		{
			class MVSWeapons
			{
				name="Rifles";
				description="";
				attachmentSlots[] = {"Shoulder2", "MVS_Weapon1", "MVS_Weapon2", "VestHolster"};
				icon="set:dayz_inventory image:shoulderleft";
			};
			class MVSAttachments
			{
				name="Attachments";
				description="";
				attachmentSlots[] = {"VestPouch", "Chemlight", "WalkieTalkie", "Belt_Back"};
				icon="set:dayz_inventory image:vestpouches";
			};
		};
	};
	class MVS_RifleBag_Black: MVS_RifleBag_Base
	{
		scope=2;
		displayName="Rifle Bag - Black";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\riflebags\mvs_riflebag_black_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_black_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_black_co.paa"};
	};
	class MVS_RifleBag_Green: MVS_RifleBag_Base
	{
		scope=2;
		displayName="Rifle Bag - Green";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\riflebags\mvs_riflebag_green_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_green_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_green_co.paa"};
	};
	class MVS_RifleBag_Tan: MVS_RifleBag_Base
	{
		scope=2;
		displayName="Rifle Bag - Tan";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\riflebags\mvs_riflebag_tan_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_tan_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_tan_co.paa"};
	};
	class MVS_RifleBag_Desert_Camo: MVS_RifleBag_Base
	{
		scope=2;
		displayName="Rifle Bag - Desert Camo";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\riflebags\mvs_riflebag_desert_camo_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_desert_camo_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_desert_camo_co.paa"};
	};
	class MVS_RifleBag_Winter: MVS_RifleBag_Base
	{
		scope=2;
		displayName="Rifle Bag - Winter";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\riflebags\mvs_riflebag_winter_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_winter_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_winter_co.paa"};
	};
	class MVS_RifleBag_Winter_Camo: MVS_RifleBag_Base
	{
		scope=2;
		displayName="Rifle Bag - Winter Camo";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\riflebags\mvs_riflebag_winter_camo_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_winter_camo_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_winter_camo_co.paa"};
	};
	class MVS_RifleBag_Diagonal_Base: MVS_RifleBag_Base
	{
		scope=0;
		displayName="Rifle Bag - Diagonal";
		model="\ModularVestSystem\data\riflebags\mvs_riflebag_d_g.p3d";
		class ClothingTypes
		{
			male="\ModularVestSystem\data\riflebags\mvs_riflebag_d_m.p3d";
			female="\ModularVestSystem\data\riflebags\mvs_riflebag_d_f.p3d";
		};
	};
	class MVS_RifleBag_Diagonal_Black: MVS_RifleBag_Diagonal_Base
	{
		scope=2;
		displayName="Rifle Bag - Diagonal Black";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\riflebags\mvs_riflebag_black_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_black_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_black_co.paa"};
	};
	class MVS_RifleBag_Diagonal_Green: MVS_RifleBag_Diagonal_Base
	{
		scope=2;
		displayName="Rifle Bag - Diagonal Green";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\riflebags\mvs_riflebag_green_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_green_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_green_co.paa"};
	};
	class MVS_RifleBag_Diagonal_Tan: MVS_RifleBag_Diagonal_Base
	{
		scope=2;
		displayName="Rifle Bag - Diagonal Tan";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\riflebags\mvs_riflebag_tan_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_tan_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_tan_co.paa"};
	};
	class MVS_RifleBag_Diagonal_Desert_Camo: MVS_RifleBag_Diagonal_Base
	{
		scope=2;
		displayName="Rifle Bag - Diagonal Desert Camo";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\riflebags\mvs_riflebag_desert_camo_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_desert_camo_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_desert_camo_co.paa"};
	};
	class MVS_RifleBag_Diagonal_Winter: MVS_RifleBag_Diagonal_Base
	{
		scope=2;
		displayName="Rifle Bag - Diagonal Winter";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\riflebags\mvs_riflebag_winter_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_winter_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_winter_co.paa"};
	};
	class MVS_RifleBag_Diagonal_Winter_Camo: MVS_RifleBag_Diagonal_Base
	{
		scope=2;
		displayName="Rifle Bag - Diagonal Winter Camo";
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\riflebags\mvs_riflebag_winter_camo_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_winter_camo_co.paa", "\ModularVestSystem\data\riflebags\mvs_riflebag_winter_camo_co.paa"};
	};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Pack\Rucksack.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Pack\Rucksack_destruct.rvmat"}}
					};
				};
			};
		};
	...
	class Modular_Belt_Base: Clothing
	{
		...
		hiddenSelectionsMaterials[] = {"ModularVestSystem\data\Belt\belt.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Belt\belt.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Belt\belt_destruct.rvmat"}}
					};
				};
			};
		};
	...
	class MVS_Sheath_Base: NylonKnifeSheath
	{
		...
		hiddenSelections[] = {"zbytek"};
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\Belt\sheath_co.paa"};
		hiddenSelectionsMaterials[] = {"ModularVestSystem\data\Belt\sheath.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Belt\sheath.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Belt\sheath_destruct.rvmat"}}
					};
				};
			};
		};
	...
	class MVS_Sheath_ERDL: MVS_Sheath_Base
	{
		...
		scope=2;
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\Belt\sheath_co_ERDL.paa"};
	};
	class MVS_Sheath_Tan: MVS_Sheath_Base
	{
		...
		scope=2;
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\Belt\sheath_co_Tan.paa"};
	};
	class MVS_Sheath_Black: MVS_Sheath_Base
	{
		...
		scope=2;
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\Belt\sheath_co_Black.paa"};
	};
	class MVS_Sheath_Snow: MVS_Sheath_Base
	{
		...
		scope=2;
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\Belt\sheath_co_snow.paa"};
	};
	class MVS_Sheath_Multicam: MVS_Sheath_Base
	{
		...
		scope=2;
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\Belt\sheath_co_MC.paa"};
	};
	class MVS_Sheath_Multicam_Tropic: MVS_Sheath_Base
	{
		...
		scope=2;
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\Belt\sheath_co_MC_Tropic.paa"};
	};
	class MVS_Sheath_Multicam_Black: MVS_Sheath_Base
	{
		...
		scope=2;
		hiddenSelectionsTextures[] = {"\ModularVestSystem\data\Belt\sheath_co_MC_Black.paa"};
	};
	...
	class ArmorRack_Kit: WoodenCrate
	{
		...
		projectionTypename = "ArmorRack_Holo";
		itemSize[] = {5, 3};
		carveNavmesh = 1;
		canBeDigged = 0;
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[] =
					{
						{1, {"DZ\gear\camping\data\spotlight.rvmat"}},
						{0.7, {"DZ\gear\camping\data\spotlight.rvmat"}},
						{0.5, {"DZ\gear\camping\data\spotlight_damage.rvmat"}},
						{0.3, {"DZ\gear\camping\data\spotlight_damage.rvmat"}},
						{0, {"DZ\gear\camping\data\spotlight_destruct.rvmat"}}
					};
				};
			};
		};
	...
	{
		scope = 1;
		displayName = "MVS Armor Rack Projection";
		descriptionShort = "Placement projection for the MVS Armor Rack.";
	...
	class MVS_S10Respirator: MVS_GasMaskBase
	{
		...
		hiddenSelectionsMaterials[] = {"ModularVestSystem\data\s10\s10.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\s10\s10.rvmat"}},
						...
						{0, {"ModularVestSystem\data\s10\s10_destruct.rvmat"}}
					};
				};
			};
		};
	...
	class MVS_PMK2Respirator: MVS_GasMaskBase
	{
		...
		hiddenSelectionsMaterials[] = {"ModularVestSystem\data\s10\MVS_Balaclava2.rvmat", "ModularVestSystem\data\s10\MVS_PMK2.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"ModularVestSystem\data\s10\MVS_Balaclava2_damage.rvmat",
								"ModularVestSystem\data\s10\MVS_PMK2_damage.rvmat"
							}
						},
						...
						
						{
							...
							{
								"ModularVestSystem\data\s10\MVS_Balaclava2_destruct.rvmat",
								"ModularVestSystem\data\s10\MVS_PMK2_destruct.rvmat"
							}
						}
					};
				};
	...
	class MVS_M50Respirator: MVS_GasMaskBase
	{
		...
		hiddenSelectionsMaterials[] = {"ModularVestSystem\data\s10\MVS_Balaclava2.rvmat", "ModularVestSystem\data\s10\MVS_M50.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"ModularVestSystem\data\s10\MVS_Balaclava2_damage.rvmat",
								"ModularVestSystem\data\s10\MVS_M50_damage.rvmat"
							}
						},
						...
						
						{
							...
							{
								"ModularVestSystem\data\s10\MVS_Balaclava2_destruct.rvmat",
								"ModularVestSystem\data\s10\MVS_M50_destruct.rvmat"
							}
						}
					};
				};
	...
	class MVS_Balaclava: BalaclavaMask_ColorBase
	{
		...
		hiddenSelectionsMaterials[] = {"ModularVestSystem\data\s10\MVS_Balaclava2.rvmat", "ModularVestSystem\data\s10\MVS_Balaclava_mask.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"ModularVestSystem\data\s10\MVS_Balaclava2_damage.rvmat",
								"ModularVestSystem\data\s10\MVS_Balaclava_mask_damage.rvmat"
							}
						},
						...
						
						{
							...
							{
								"ModularVestSystem\data\s10\MVS_Balaclava2_destruct.rvmat",
								"ModularVestSystem\data\s10\MVS_Balaclava_mask_destruct.rvmat"
							}
						}
					};
				};
	...
	class MVS_Balaclava2: BalaclavaMask_ColorBase
	{
		...
		hiddenSelectionsMaterials[] = {"ModularVestSystem\data\s10\MVS_Balaclava2.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\s10\MVS_Balaclava2.rvmat"}},
						...
						{0, {"ModularVestSystem\data\s10\MVS_Balaclava2_destruct.rvmat"}}
					};
				};
			};
		};
	...
	class MVS_Shroud_Base: BalaclavaMask_ColorBase
	{
		...
		hiddenSelectionsMaterials[] = {"ModularVestSystem\data\s10\MVS_Shroud.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\s10\MVS_Shroud.rvmat"}},
						...
						{0, {"ModularVestSystem\data\s10\MVS_Shroud_destruct.rvmat"}}
					};
				};
			};
		};
	...
	class MVS_Cap_Base: Clothing
	{
		...
		descriptionShort="The MVS Patrol Cap can attach an identifier patch and MVS Comtacs.";
		...
		headSelectionsToHide[] = {"Clipping_baseballcap"};
		hiddenSelections[] = {"camoGround", "camoMale", "camoFemale"};
		hiddenSelectionsMaterials[] = {"ModularVestSystem\data\Helmets\MVS_Cap.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Helmets\MVS_Cap.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Helmets\MVS_Cap_destruct.rvmat"}}
					};
				};
			};
		};
	...
	class MVS_Comtacs_Base: BalaclavaMask_ColorBase
	{
		...
		descriptionShort="MVS Comtacs - a trusted tactical communications and hearing protection headset that is field proven by law enforcement and militaries worldwide.";
		model="\ModularVestSystem\data\Helmets\MVS_Comtacs_g.p3d";
		inventorySlot[] = {"Headgear", "MVS_Comtacs"};
		simulation="clothing";
		vehicleClass="Clothing";
		itemInfo[] = {"Clothing", "Headgear"};
		rotationFlags=0;
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"DZ\characters\headgear\data\BaseballCapII.rvmat"}},
						{0.7, {"DZ\characters\headgear\data\BaseballCapII.rvmat"}},
						{0.5, {"DZ\characters\headgear\data\BaseballCapII_damage.rvmat"}},
						{0.3, {"DZ\characters\headgear\data\BaseballCapII_damage.rvmat"}},
						{0, {"DZ\characters\headgear\data\BaseballCapII_destruct.rvmat"}}
					};
				};
			};
		};
	...
	class MVS_CombatPants_Base: BDUPants
	{
		...
		hiddenSelectionsMaterials[] = {"ModularVestSystem\data\Uniforms\MVS_CombatPants.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Uniforms\MVS_CombatPants.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Uniforms\MVS_CombatPants_destruct.rvmat"}}
					};
				};
			};
		};
	...
	class MVS_CombatShirt_Base: TacticalShirt_ColorBase
	{
		...
		quickBarBonus=1;
		hiddenSelections[] = {"camoGround", "camoMale", "camoFemale"};
		hiddenSelectionsMaterials[] = {"ModularVestSystem\data\Uniforms\MVS_CombatShirt.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1, {"ModularVestSystem\data\Uniforms\MVS_CombatShirt.rvmat"}},
						...
						{0, {"ModularVestSystem\data\Uniforms\MVS_CombatShirt_destruct.rvmat"}}
					};
				};
			};
		};
	...
	class Modular_Patch_Base: Clothing
	{
		...
		descriptionShort="MVS Identifier Patch with a variety of patterns and emblems.";
		...
		hiddenSelectionsMaterials[] = {"ModularVestSystem\data\vestTextures\patch.rvmat", "ModularVestSystem\data\vestTextures\MVS_Armband.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
	...
	class Modular_Patch_Base_2: Clothing
	{
		...
		hiddenSelectionsMaterials[] = {"ModularVestSystem\data\vestTextures\MVS_Country_Patch.rvmat", "ModularVestSystem\data\vestTextures\MVS_Armband.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
...
class cfgWeapons
{
	...
	{
		inventorySlot[] += {"MVS_Weapon1", "MVS_Weapon2", "Shoulder2"};
	};
};
class CfgSlots
{
...
class CfgNonAIVehicles
{
	...
	class Proxyshoulder2: ProxyAttachment
	{
		...
		model="\ModularVestSystem\data\riflebags\proxies\shoulder2.p3d";
	};
